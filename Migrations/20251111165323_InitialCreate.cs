    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VarasOrigem", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NumeroUnificado = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Titulo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StatusAndamento = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DescricaoAndamento = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    VaraOrigemId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Processos_TiposProcessos_TipoProcessoId",
                        column: x => x.TipoProcessoId,
                        principalTable: "TiposProcessos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Processos_VarasOrigem_VaraOrigemId",
                        column: x => x.VaraOrigemId,
                        principalTable: "VarasOrigem",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Processos_VaraOrigemId",
                table: "Processos",
                column: "VaraOrigemId");
        }
